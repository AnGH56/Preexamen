...
namespace Preexamen.Models {
    ...
    public partial class DsUniversidad : global::System.Data.DataSet {
        ...
        public partial class alumnosDataTable : global::System.Data.TypedTableBase<alumnosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public alumnosRow AddalumnosRow(int AlumnoID, string Nombre, string Apellido, string FechaNacimiento, string Correo) {
...
namespace Preexamen.Models.DsUniversidadTableAdapters {
    ...
    public partial class alumnosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `alumnos` (`AlumnoID`, `Nombre`, `Apellido`, `FechaNacimiento`, `Corr" +
                "eo`) VALUES (@p1, @p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `alumnos` SET `AlumnoID` = @p1, `Nombre` = @p2, `Apellido` = @p3, `FechaNa" +
                "cimiento` = @p4, `Correo` = @p5 WHERE ((`AlumnoID` = @p6) AND (`Nombre` = @p7) A" +
                "ND (`Apellido` = @p8) AND (`FechaNacimiento` = @p9) AND (`Correo` = @p10))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Preexamen.Properties.Settings.Default.universidad3ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT        AlumnoID, Nombre, Apellido, FechaNacimiento, Correo\r\nFROM          " +
                "  alumnos\r\nWHERE        (AlumnoID = @ID)";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO alumnos\n    (AlumnoID,Nombre, Apellido, FechaNacimiento, Correo)\nVALU" +
                "ES        (@AlumnoID,@Nombre, @Apellido, @FechaNacimiento, @Correo)";
        ...
        public virtual int Fill(DsUniversidad.alumnosDataTable dataTable) {
        ...
        public virtual DsUniversidad.alumnosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DsUniversidad.alumnosDataTable dataTable = new DsUniversidad.alumnosDataTable();
        ...
        public virtual int FillBy(DsUniversidad.alumnosDataTable dataTable, int ID) {
        ...
        public virtual DsUniversidad.alumnosDataTable GetDataByID(int ID) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ID));
            DsUniversidad.alumnosDataTable dataTable = new DsUniversidad.alumnosDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DsUniversidad.alumnosDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DsUniversidad dataSet) {
        ...
        public virtual int InsertAlumnos(int AlumnoID, string Nombre, string Apellido, string FechaNacimiento, string Correo) {
        ...
        public virtual int UpdateAlumno(string NOMBRE, string APELLIDO, string FECHANACIMIENTO, string CORREO, int ALUMNOID) {
            ...
            command.Parameters[4].Value = ((int)(ALUMNOID));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(DsUniversidad dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._alumnosTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(DsUniversidad dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._alumnosTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(DsUniversidad dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._alumnosTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(DsUniversidad dataSet) {
            if ((dataSet == null)) {
